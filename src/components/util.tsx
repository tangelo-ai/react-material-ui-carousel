...
export interface SanitizedCarouselProps extends CarouselProps {
  ...
  nextNavButtonWrapperProps: SanitizedCarouselNavProps;
  prevNavButtonWrapperProps: SanitizedCarouselNavProps;
...
export const sanitizeProps = (props: CarouselProps): SanitizedCarouselProps => {
  ...
  return {
    ...
    nextNavButtonWrapperProps: sanitizeNavProps(
      props.nextNavButtonWrapperProps
    ),
    prevNavButtonWrapperProps: sanitizeNavProps(
      props.prevNavButtonWrapperProps
    ),
